                        ...
                        <form method="post" class="card-body">
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="question_title" placeholder="e.g. Is there an R function for finding the index of an element in a vector?">
                                </div>
                            </div><!-- end input-box -->
                            <div class="input-box">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="generic-popover d-none">
                                        ...
                                        <ul class="generic-list-item generic-list-item-bullet">
                                            ...
                                            <li class="lh-18 text-black-50">Include tags that are crucial to your question only, like <div class="tag-link">c#</div>
                                            </li>
