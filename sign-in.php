...
======================================-->
    <section class="login-area pt-80px pb-80px position-relative">
        ...
        <div class="container">
                    ...
                    <div class="col-lg-5 mx-auto">
                        <div class="form-action-wrapper py-5">
                            <div class="form-group">
                                <h3 class="fs-22 pb-3 fw-bold">Log in to Student Stack Overflow</h3>
                            ...
                            <div class="form-group">
                                <button id="send-message-btn" class="btn theme-btn w-100" name="sign-up-btn" type="submit">Log in <i class="la la-arrow-right icon ml-1"></i></button>
                            </div><!-- end form-group -->
            ...
            <p class="text-black text-center fs-15">Don't have an account? <a href="sign-up.php" class="text-color hover-underline">Sign up</a></p>
        </div><!-- end container -->
    </section>
    <!--======================================
        END LOGIN AREA
